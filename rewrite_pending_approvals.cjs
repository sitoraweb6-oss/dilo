    ...
    <section className="mb-6">
      ...
      <div className="space-y-3">
        ...
        {pendingPayments.map(payment => (
          <PendingPaymentItem key={payment.id} payment={payment} user={usersMap[payment.userId]} currentUser={userProfile!} />
        ))}
...
`;
fs.writeFileSync('src/components/home/PendingApprovalsSection.tsx', content);
